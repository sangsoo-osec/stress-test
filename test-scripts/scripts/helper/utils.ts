...
import { SuiClient, GetCoinsParams } from "@mysten/sui/client";
...
export class Utils {
    ...
    public static async getDeployer(): Promise<Ed25519Keypair> {
        return Ed25519Keypair.fromSecretKey(base64ToUint8Array("0000000000000000000000000000000000000000000"));
    }
